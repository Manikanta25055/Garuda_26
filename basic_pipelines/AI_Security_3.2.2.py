...
##############################################################################
# HELPER FUNCTION: Update a Text Widget Without Resetting Scroll Position
##############################################################################
def update_text_widget(widget, new_text):
    ...
    # If the widget was scrolled to bottom, then keep it at bottom; otherwise restore previous view.
...
def send_email_alert():
    ...
    msg['To'] = "amarmanikantan@gmail.com"
    try:
...
def voice_assistant_loop(stop_event):
    ...
    while not stop_event.is_set():
        ...
        # Check for deactivation commands first:
        if "deactivate dnd" in user_input_lower:
        ...
        elif "last night" in user_input_lower:
            MODE_NIGHT = True
            if dashboard_gui:
            ...
            response = "I'm sorry, I am still working on it."
        append_voice_response(response)
        # Update GUI checkbuttons:
        if dashboard_gui:
...
class SecurityDashboardGUI:
    def __init__(self, root, user_data):
        ...
        # Narada Control Section (for start/stop) with Listening Indicator and Clear Log button
        ...
        # Listening indicator (a colored dot)
        ...
        self.listening_indicator.config(foreground="red")  # Red for not active
        # "Clear Log" button
...
if __name__ == "__main__":
    ...
    # Create and assign the GUI instance
    root = tk.Tk()
