...
# Additional imports (serial and re can be removed if not used)
import serial
import re
...
MODE_NIGHT = False       # High priority mode: alerts last 10 sec (instead of 5) and email subject is modified
...
##############################################################################
# VOICE ASSISTANT LOOP (Fixed-response Version)
##############################################################################
