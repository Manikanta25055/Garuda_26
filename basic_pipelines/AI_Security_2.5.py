...
class SecurityDashboardGUI:
    def __init__(self, root, user_data):
        ...
        # Notebook => only one tab for "AI Detections" (since ESP32 is removed)
    ...
    def update_gui(self):
        ...
        # Show detection info in blue if line has "detected"
