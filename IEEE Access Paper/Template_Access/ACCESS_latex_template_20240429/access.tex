...
\caption{Three-model comparison on the held-out test set. COCO-pretrained YOLOv8s scores near zero on this four-class task; fine-tuning on 359 images (v1) recovers to 0.465 mAP{@}0.5, and scaling to 4{,}982 images (v5) reaches 0.847 --- an 82\% gain driven entirely by dataset growth.}
